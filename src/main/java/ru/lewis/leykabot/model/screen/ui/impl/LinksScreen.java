...
public class LinksScreen extends AbstractScreen {
    ...
    public LinksScreen(Long chatId, Long userId, ButtonsLocConfig buttonsLocConfig,
    ...
    public String getText() {
        return clientMessageConfig.getLinksCommand();
    }
}
